...
def run_single_file(args):
    ...
    out_array = get_paper_ecg(input_file=filename, header_file=header, output_directory=args.output_directory,
                              ...
                              add_dc_pulse=bernoulli_dc, add_bw=bernoulli_bw, show_grid=bernoulli_grid,
                              add_print=bernoulli_add_print, pad_inches=padding, font_type=font,
                              standard_colours=standard_colours, full_mode=args.full_mode, bbox=args.bbox,
                              columns=args.num_columns, seed=args.seed)
    ...
    for out in out_array:
        ...
        if wrinkles:
            ...
            out = get_creased(out, output_directory=args.output_directory, ifWrinkles=ifWrinkles, ifCreases=ifCreases,
                              ...
                              num_creases_horizontally=num_creases_horizontally, bbox=args.bbox)
